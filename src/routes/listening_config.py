...
from implement.interactor.listening_config.rdb_listening_config_interactor import (
...
@router.put("/update/{config_id}", response_model=UpdateListeningConfigOutData)
def update(
